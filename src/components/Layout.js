    ...
    return(
        <div className="relative w-full flex flex-col min-h-screen"> 
            ...
            <main className="flex-1 xl:px-[20%] lg:px-[10%] md:px-[5%] pt-[5%] z-10">
                ...
                <h1 className={`xl:text-5xl md:text-4xl text-3xl sm:pb-14 text-[#F47500] mb-10 font-semibold md:text-left text-center mt-10 px-10 sm:px-0 ${noTitle ? "hidden" : ""}`}>{PageTitle}</h1>
                {children}
            </main>
